...
$catalogue = new MessageCatalogue('be', array (
  ...
  array (
    ...
    'This value is too short. It should contain at least one word.|This value is too short. It should contain at least {{ min }} words.' => 'Гэта значэнне занадта кароткае. Яно павінна ўтрымліваць хаця б адно слова.|Гэта значэнне занадта кароткае. Яно павінна ўтрымліваць хаця б {{ min }} словы.',
    'This value is too long. It should contain one word.|This value is too long. It should contain {{ max }} words or less.' => 'Гэта значэнне занадта доўгае. Яно павінна ўтрымліваць адно слова.|Гэта значэнне занадта доўгае. Яно павінна ўтрымліваць {{ max }} словы або менш.',
    'This value does not represent a valid week in the ISO 8601 format.' => 'Гэта значэнне не адпавядае правільнаму тыдні ў фармаце ISO 8601.',
    ...
    'This value is not a valid slug.' => 'Гэта значэнне не з\'яўляецца сапраўдным слугам.',
