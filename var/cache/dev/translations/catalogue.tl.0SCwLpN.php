...
$catalogue = new MessageCatalogue('tl', array (
  ...
  array (
    ...
    'No temporary folder was configured in php.ini.' => 'Walang pansamantalang folder na na-configure sa php.ini, o ang naka-configure na folder ay hindi umiiral.',
    ...
    'This value is not a valid CIDR notation.' => 'Ang halagang ito ay hindi wastong notasyong CIDR.',
    ...
    'This URL is missing a top-level domain.' => 'Kulang ang URL na ito sa top-level domain.',
    ...
    'This value is not a valid slug.' => 'Ang halagang ito ay hindi isang wastong slug.',
  ...
  array (
    ...
    'Too many failed login attempts, please try again in %minutes% minutes.' => 'Napakaraming nabigong pagtatangka ng pag-login, mangyaring subukang muli sa loob ng %minutes% minuto.|Napakaraming nabigong pagtatangka ng pag-login, mangyaring subukang muli sa loob ng %minutes% minuto.',
  ),
));
