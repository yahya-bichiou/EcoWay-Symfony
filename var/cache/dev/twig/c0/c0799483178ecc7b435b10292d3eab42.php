...
class __TwigTemplate_6c1035285391ada0dd0525480e252bd3 extends Template
{
          ...
          <form id=\"contact\" action=\"\" method=\"post\" novalidate>
            <div class=\"row\">
              ...
              <div class=\"col-lg-4 offset-lg-4\">
                    ";
        // line 19
        yield Twig\Extension\CoreExtension::include($this->env, $context, "utilisateur/_form.html.twig");
        yield "
                    <form action=\"";
        // line 20
          ...
          <form id=\"contact\" action=\"\" method=\"post\" novalidate>
            <div class=\"row\">
              ...
              <div class=\"col-lg-4 offset-lg-4\">
                    ...
                    <form action=\"{{ path('app_utilisateur_index') }}\">
                    <button class=\"btn\">Retour</button>
                    </form>
              </div>
          </form>
...
{% endblock %}
", "utilisateur/new.html.twig", "C:\\Users\\User\\Downloads\\EcoWay-produit (1)\\EcoWay-produit\\templates\\utilisateur\\new.html.twig");
    }
}
