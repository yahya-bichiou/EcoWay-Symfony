...
class __TwigTemplate_a02ae26d2d5224a797f808b3cdeb4e01 extends Template
{
...
<button class=\"btn btn-primary\">";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 16, $this->source); })()), "Enregistrer")) : ("Enregistrer")), "html", null, true);
        yield "</button>
...
";
    ...
    {
        return array (  89 => 18,  84 => 16,  77 => 12,  73 => 11,  69 => 10,  63 => 7,  59 => 6,  55 => 5,  48 => 1,);
    }
...
<table>
    <tr>
        <td>{{ form_label(form.nom, \"Nom de la catégorie\") }}</td>
