 ...
 */
class getCollecteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CollecteRepository' shared autowired service.
     *
     * @return \App\Repository\CollecteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CollecteRepository.php';

        return $container->privates['App\\Repository\\CollecteRepository'] = new \App\Repository\CollecteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
