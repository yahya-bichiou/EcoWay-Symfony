 ...
 */
class getCommandesBoutiqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandesBoutiqueRepository' shared autowired service.
     *
     * @return \App\Repository\CommandesBoutiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandesBoutiqueRepository.php';

        return $container->privates['App\\Repository\\CommandesBoutiqueRepository'] = new \App\Repository\CommandesBoutiqueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
