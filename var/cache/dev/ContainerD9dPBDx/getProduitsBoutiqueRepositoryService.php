 ...
 */
class getProduitsBoutiqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProduitsBoutiqueRepository' shared autowired service.
     *
     * @return \App\Repository\ProduitsBoutiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProduitsBoutiqueRepository.php';

        return $container->privates['App\\Repository\\ProduitsBoutiqueRepository'] = new \App\Repository\ProduitsBoutiqueRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
