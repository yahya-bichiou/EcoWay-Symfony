...
class PdfGeneratorService
{
    public function generateInvoice(array $commandeData): string
    {
        ...
        $pdf->Cell(0, 10, 'Facture N°' . $commandeData['id'], 0, 1, 'C');
        ...
        foreach ($commandeData['produits'] as $produit) {
            ...
            $pdf->Cell(40, 10, $produit['prix'] . 'DT', 1);
            $pdf->Cell(30, 10, $produit['quantity'], 1);
            $pdf->Cell(40, 10, ($produit['prix'] * $produit['quantity']) . 'DT', 1);
            $pdf->Ln();
        }
        ...
        $pdf->Cell(40, 10, $commandeData['prix'] . 'DT', 1, 1, 'R');
